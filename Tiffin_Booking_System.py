...
mydb= mysql.connector.connect(host="localhost", user="", passwd="", database="project", auth_plugin="mysql_native_password")
cursor = mydb.cursor()

#width=os.get_terminal_size().columns
print("WELCOME TO THE TIFFIN BOOKING SYSTEM")#.center(width))
SignUp_Choice=input("Do you want to create a new account (yes/no) :")
...
if SignUp_Choice=="no":
    ...
    for row1 in result:
        ...
        if Data==Enter_Password:
            ...
            print("1. Book your Tifffin")
            print("2. Check Tiffin Status")
            print("3. Check Tiffin and Customer Details")
            print("4. Update Details")
            print("5. Cancle Tiffin Subscription")
            print("6. Master Login")
            ...
            if option_selection==1:
                ...
                print("Enter the number of the item you want to order and press enter to add more items press 8 if you are done adding the items")
    ...
    print("Please enter the following information and PRESS ENTER to proceed")
